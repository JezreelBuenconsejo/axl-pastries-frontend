...
const CakeDialog: React.FC<CakeDialogProps> = ({
  ...
  return (
    <Dialog>
      <DialogTrigger
        className={mode === "update" ? "text-yellow-500" : "rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600"}
        onClick={() => {
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              ...
              {previews.map((src, index) => (
                <div key={index} className="flex h-20 w-20 items-center justify-center rounded border-2 border-black">
