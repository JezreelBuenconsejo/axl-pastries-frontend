...
const FeaturedProductCard: React.FC<FeaturedProductCardProps> = (props) => {
  return (
    <div className="rounded-lg shadow-md p-6 my-1 w-full md:w-[293px]  flex flex-col justify-between">
      <div className="flex justify-center w-fit mx-auto">
        <img className="rounded-cakeShape border-2 border-main-purple aspect-square object-cover " src={props.img} alt="" width={undefined} />
      </div>
